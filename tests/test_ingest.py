...
def test_ingest_filesystem_success():
    ...
    fake_docs = [Document(id="1", source="/home/user/file1.txt", metadata={}, checksum="abc123", created_at=datetime.utcnow()),
                 Document(id="2", source="/home/user/IgnorePath/file2.txt", metadata={}, checksum="def456", created_at=datetime.utcnow())]
